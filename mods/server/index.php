...
/*                       thumb           track                                 */
    ...
    /* GITHUB CORNER BEGIN  */
    div.header_information div.disclaimer .github-corner {
        position: absolute;
        display: block;
        width: 353px;
        height: 111px;
    }
    div.header_information div.disclaimer .github-corner svg {
        z-index: 2024;
    ...
    div.header_information div.disclaimer .github-corner:hover .octo-arm {
...
function github_urls($server_mod) {
    ...
    $github_urls = $github_urls ? $github_urls : "<span class=\"not_on_github\">not<br>released<br>on<br>github</span>";
...
<div class="header_container">
    ...
    <div class="header_information">
        <div class="disclaimer">
            <a class="github-corner" href="https://github.com/jesterjunk/WurmUnlimited" target="_blank" title="View source on GitHub" aria-label="View source on GitHub">
                <svg width="111" height="111" viewBox="0 0 250 250" aria-hidden="true">
                    <path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path>
                    <path fill="currentColor" class="octo-arm"  d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2"></path>
